<p align="center">
<img src="https://static.bg-software.com/imgs/wildtools-logo.png" />
...
You can compile the project using Maven.<br>
Run `mvn clean package` in console to build the project.<br>
